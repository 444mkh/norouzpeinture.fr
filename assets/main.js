					...
					// Determine target.
						...
						// Missing initial section?
							if (!initialSection) {
								...
								// Default to index.
									initialScrollPoint = null;
									initialSection = $('#' + 'accueil' + '-section');
									initialId = initialSection.id;
	...
	// Slideshow: slideshow01.
		(function() {
			...
			new slideshowBackground('slideshow01', {
				...
				images: [
					{
						src: 'assets/images/slideshow01-288e8fac.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow01-46b5fd93.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow01-3519c60b.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow01-57d94c7a.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow01-4dfcdc09.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow01-24a6097e.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow01-d103d7dc.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
